...
Caso Possua o gerenciador de container instalado rode <kbd>lando start</kbd> para iniciar a aplicação, e depois <kbd>lando db-import ./database/dump.sql</kbd> para importar os dados da aplicação e após popular o banco, rodar <kbd>lando drush cr</kbd>.
